				...
				<div class="card shadow-2-strong" style="border-radius: 1rem;">
					<div class="card-body p-5 text-center">
						...
						<div class="form-outline mb-4">
							<input on:keypress={submitOnEnter} bind:value={username} type="text" id="typeEmailX-2" class="form-control form-control-lg" />
							<label class="form-label" for="typeEmailX-2">Username</label>
						</div>

						<div class="form-outline mb-4">
							<input on:keypress={submitOnEnter} bind:value={password} type="password" id="typePasswordX-2" class="form-control form-control-lg" />
